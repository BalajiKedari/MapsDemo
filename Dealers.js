...
function getDealers() {
...

  {
    ...
    "name": null,
    "type": 1,
    "lastUpdateDate": "2016-11-06T12:18:51.2916913+00:00"
  },
  ...
  var dealers = _.map(response, function (dealer) {
    ...
    var dealerPoint = dealer.location && dealer.location.coordinates;
    var dealerLocation;
    if (dealerPoint) {
      dealerLocation = {
        lat: dealerPoint[1],
